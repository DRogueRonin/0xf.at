...
class Hackit23 implements Hackit
{
	...
	public function getDescription(){return 'Jerry set up a TCP server on <span class="green">' . $_SERVER['SERVER_ADDR'] . '</span> port <span class="green">2323</span> that holds the password for this level.<br/>All you have to do is connect (with the "telnet" command or <a target="_blank" href="http://netcat.sourceforge.net/">"netcat"</a>), send the auth token below and wait for the password.';}
